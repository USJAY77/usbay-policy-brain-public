...
_Last run: 2026-06-26 14:59:25Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.62s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **8.0 s**
- DOM-suite phase: 5.2 s
- Warm run (this run, from harness `__timing`): import=2976 ms · construct=395 ms · execution=533 ms · total=3910 ms
...
- This run: 8.0 s -> within expected window (<= 300s)
