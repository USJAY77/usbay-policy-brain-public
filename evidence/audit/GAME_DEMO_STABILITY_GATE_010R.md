...
_Last run: 2026-06-25 18:52:56Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 3.81s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **6.3 s**
- DOM-suite phase: 4.4 s
- Warm run (this run, from harness `__timing`): import=2163 ms · construct=376 ms · execution=443 ms · total=2988 ms
...
- This run: 6.3 s -> within expected window (<= 300s)
