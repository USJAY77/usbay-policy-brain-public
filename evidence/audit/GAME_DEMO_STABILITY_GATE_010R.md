...
_Last run: 2026-07-07 14:00:27Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 5.01s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **8.5 s**
- DOM-suite phase: 5.6 s
- Warm run (this run, from harness `__timing`): import=3161 ms · construct=501 ms · execution=548 ms · total=4217 ms
...
- This run: 8.5 s -> within expected window (<= 300s)
