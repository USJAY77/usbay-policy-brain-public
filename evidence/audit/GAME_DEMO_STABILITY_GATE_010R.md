...
_Last run: 2026-08-15 19:26:30Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.08s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **11.1 s**
- DOM-suite phase: 6.3 s
- Warm run (this run, from harness `__timing`): import=2377 ms · construct=406 ms · execution=390 ms · total=3180 ms
...
- This run: 11.1 s -> within expected window (<= 300s)
