...
_Last run: 2026-07-08 20:24:22Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.01s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **7.0 s**
- DOM-suite phase: 4.6 s
- Warm run (this run, from harness `__timing`): import=2227 ms · construct=416 ms · execution=514 ms · total=3163 ms
...
- This run: 7.0 s -> within expected window (<= 300s)
