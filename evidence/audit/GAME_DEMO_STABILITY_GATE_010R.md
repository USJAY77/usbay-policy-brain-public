...
_Last run: 2026-06-23 20:32:01Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 1.88s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **2.9 s**
- DOM-suite phase: 2.3 s
- Warm run (this run, from harness `__timing`): import=577 ms · construct=288 ms · execution=320 ms · total=1193 ms
...
- This run: 2.9 s -> within expected window (<= 300s)
