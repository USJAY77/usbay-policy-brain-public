...
_Last run: 2026-07-09 14:58:42Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.14s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **7.3 s**
- DOM-suite phase: 4.7 s
- Warm run (this run, from harness `__timing`): import=2420 ms · construct=414 ms · execution=509 ms · total=3352 ms
...
- This run: 7.3 s -> within expected window (<= 300s)
