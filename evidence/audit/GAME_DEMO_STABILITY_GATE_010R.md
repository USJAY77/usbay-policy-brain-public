...
_Last run: 2026-07-08 14:58:59Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 5.43s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **8.9 s**
- DOM-suite phase: 6.1 s
- Warm run (this run, from harness `__timing`): import=3281 ms · construct=516 ms · execution=629 ms · total=4437 ms
...
- This run: 8.9 s -> within expected window (<= 300s)
