...
_Last run: 2026-08-05 18:54:06Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 3.39s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **4.6 s**
- DOM-suite phase: 3.9 s
- Warm run (this run, from harness `__timing`): import=1463 ms · construct=622 ms · execution=586 ms · total=2687 ms
...
- This run: 4.6 s -> within expected window (<= 300s)
