...
_Last run: 2026-06-24 08:03:49Z_  ·  **Overall result: FAIL**
...
- Summary: `23 passed in 9.38s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **12.2 s**
- DOM-suite phase: 10.5 s
- Warm run (this run, from harness `__timing`): import=4529 ms · construct=704 ms · execution=629 ms · total=5876 ms
...
- This run: 12.2 s -> within expected window (<= 300s)
