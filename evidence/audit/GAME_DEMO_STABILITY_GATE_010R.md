...
_Last run: 2026-06-25 14:55:09Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 5.09s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **8.7 s**
- DOM-suite phase: 5.9 s
- Warm run (this run, from harness `__timing`): import=3304 ms · construct=483 ms · execution=565 ms · total=4367 ms
...
- This run: 8.7 s -> within expected window (<= 300s)
