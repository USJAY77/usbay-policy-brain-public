...
_Last run: 2026-07-04 10:47:52Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.09s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **6.6 s**
- DOM-suite phase: 4.8 s
- Warm run (this run, from harness `__timing`): import=2332 ms · construct=460 ms · execution=520 ms · total=3319 ms
...
- This run: 6.6 s -> within expected window (<= 300s)
