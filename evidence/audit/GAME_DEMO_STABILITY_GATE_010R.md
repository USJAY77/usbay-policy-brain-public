...
_Last run: 2026-07-09 04:02:22Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.44s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **7.7 s**
- DOM-suite phase: 5.1 s
- Warm run (this run, from harness `__timing`): import=2602 ms · construct=473 ms · execution=492 ms · total=3574 ms
...
- This run: 7.7 s -> within expected window (<= 300s)
