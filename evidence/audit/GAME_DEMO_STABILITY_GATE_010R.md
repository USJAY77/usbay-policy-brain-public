...
_Last run: 2026-06-25 04:31:48Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.38s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **7.1 s**
- DOM-suite phase: 5.0 s
- Warm run (this run, from harness `__timing`): import=2868 ms · construct=330 ms · execution=500 ms · total=3703 ms
...
- This run: 7.1 s -> within expected window (<= 300s)
