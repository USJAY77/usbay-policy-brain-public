...
_Last run: 2026-08-06 04:05:19Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.27s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **12.6 s**
- DOM-suite phase: 5.2 s
- Warm run (this run, from harness `__timing`): import=2666 ms · construct=359 ms · execution=317 ms · total=3348 ms
