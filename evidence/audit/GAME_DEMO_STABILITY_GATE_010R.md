...
_Last run: 2026-08-05 19:03:26Z_  ·  **Overall result: PASS**
...
- Summary: `23 passed in 4.13s`
- passed=23 failed=0 skipped=0 errors=0
- Result: **PASS** (a skip is treated as a failure - no silent skips)

## Runtime benchmark
- Total gate runtime: **8.1 s**
- DOM-suite phase: 4.8 s
- Warm run (this run, from harness `__timing`): import=1761 ms · construct=557 ms · execution=480 ms · total=2808 ms
...
- This run: 8.1 s -> within expected window (<= 300s)
