...
def evaluate_prompt_lineage(record: dict[str, Any] | None) -> dict[str, Any]:
    reasons: list[str] = []
    ...
    return {"prompt_lineage_status": "VALID" if not clean else "BLOCKED", "reason_codes": clean, "read_only": True}
