...
def evaluate_model_policy_binding(record: dict[str, Any] | None) -> dict[str, Any]:
    reasons: list[str] = []
    ...
    return {"model_policy_binding_status": "VALID" if not clean else "BLOCKED", "reason_codes": clean, "read_only": True}
