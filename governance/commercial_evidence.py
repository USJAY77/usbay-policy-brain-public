...
def evaluate_commercial_evidence(record: dict[str, Any] | None) -> dict[str, Any]:
    reasons: list[str] = []
    ...
    return {"commercial_evidence_status": "VALID" if not clean else "BLOCKED", "reason_codes": clean, "read_only": True}
