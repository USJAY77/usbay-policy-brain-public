...
def evaluate_connector_lineage(record: dict[str, Any] | None) -> dict[str, Any]:
    reasons: list[str] = []
    ...
    return {"connector_lineage_status": "VALID" if not clean else "BLOCKED", "reason_codes": list(clean), "read_only": True}
